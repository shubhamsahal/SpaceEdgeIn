...
# Get the absolute paths for templates and static folders relative to the repository root.
# This assumes your directory structure is `SpaceEdgeIn/templates` and `SpaceEdgeIn/static`
# and your app file is in `SpaceEdgeIn/api/index.py`.
